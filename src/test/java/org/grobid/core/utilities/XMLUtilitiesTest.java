...
public class XMLUtilitiesTest {
    ...
    @Test
    public void testParsingBiblio5() throws Exception {
        try {
            String testString = "<biblStruct xmlns=\"http://www.tei-c.org/ns/1.0\" xml:id=\"pcbi-0010007-b01\">\n"+
                "<analytic>\n"+
                    "<title level=\"a\" type=\"main\">DNA replication in yeast.</title>\n"+
                    "<author>\n"+
                        "<persName>\n"+
                            "<surname>Newlon</surname>\n"+
                            "<forename type=\"first\">CS</forename>\n"+
                            "</persName>\n"+
                        "</author>\n"+
                        "<editor>\n"+
                            "<surname>DePamphilis</surname>\n"+
                            "<forename type=\"first\">ML</forename>\n"+
                        "</editor>\n"+
                "</analytic>\n"+
                "<monogr>\n"+
                    "<title level=\"j\">DNA replication in eukaryotic cells</title>\n"+
                    "<imprint>\n"+
                        "<publisher>Cold Spring Harbor Laboratory Press</publisher>\n"+
                        "<pubPlace>Cold Spring Harbor (New York)</pubPlace>\n"+
                        "<date type=\"year\">1996</date>\n"+
                        "<biblScope from=\"873\" unit=\"page\">873</biblScope>\n"+
                        "<biblScope to=\"914\" unit=\"page\">914</biblScope>\n"+
                    "</imprint>\n"+
                "</monogr>\n"+
            "</biblStruct>";
