...
/**
 * Tokenizer for all Indo-European languages and identifying software mentions.
 *
 * @author Patrice
 */

public class SoftwareAnalyzer implements org.grobid.core.analyzers.Analyzer {

    private static volatile SoftwareAnalyzer instance;

    public static SoftwareAnalyzer getInstance() {
        if (instance == null) {
            //double check idiom
    ...
    private static synchronized void getNewInstance() {
        instance = new SoftwareAnalyzer();
    }

    /**
     * Hidden constructor
     */
    private SoftwareAnalyzer() {
    }
