 ...
 *   content.
 *
 * Just as a reference, from the text mining point of view - I mention here that 
 ...
 * annotations rather than the super heavy and painful semantic web framework which 
 ...
 * @author Patrice
 */
public class AnnotatedCorpusGenerator {
        ...
        for(int n=0; n < subDir.length; n++) {
            ...
            for(int i=0; i < refFiles.length; i++) {
                ...
                try {
                    ...
                    nxp.parse(is, Charset.forName("UTF-8"), null);
    ...
    public static void main(String[] args) {
        ...
        AnnotatedCorpusGenerator converter = new AnnotatedCorpusGenerator();
